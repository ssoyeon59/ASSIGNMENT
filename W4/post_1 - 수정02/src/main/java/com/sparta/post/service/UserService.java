...
import com.sparta.post.repository.RefreshTokenRepositroy;
...
public class UserService {
    ...
    // 회원가입
    public UserResponseDto registerUser(@Valid UserRequestDto userRequestDto) throws IllegalAccessException {
        String username = userRequestDto.getUsername();
        String password = userRequestDto.getPassword();
        String samepassword = userRequestDto.getPasswordConfirm();
        ...
        UserRequestDto dto = UserRequestDto.builder()
                ...
                .passwordConfirm(encodedPassword)
                .build();
